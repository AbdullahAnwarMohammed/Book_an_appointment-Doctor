      ...
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item"><a class="navbar-brand" href="index-2.html">
              <h3 class="brand-text text-center">لوحة تحكم الدكتور</h3></a></li>
              ...
              <ul class="mega-dropdown-menu dropdown-menu row p-1">
                ...
                <li class="col-md-5 px-2">
                  ...
                  <ul class="row mt-2">
                    ...
                    <li class="col-6 col-xl-4"><a class="text-center mb-2 mb-xl-3 mt-75 mt-xl-0" href="index.html" target="_blank"><i class="la la-stethoscope font-large-1 mr-0"></i>
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail"></i></a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                    <div class="media">
                      <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="/backend/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="/backend/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span></div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="/backend/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span></div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="/backend/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span></div>
                      <div class="media-body">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">{{Auth::guard('doctor')->user()->name}}</span><span class="avatar avatar-online"><img src="/backend/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></a>
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="{{route('doctor.profile')}}"><i class="ft-user"></i> البيانات الاساسية</a>
            
                <div class="dropdown-divider"></div>
                <a onclick="document.getElementById('logout').submit()" class="dropdown-item" href="#"><i class="ft-power"></i> تسجيل الخروج</a>
                <form id="logout" action="{{route('frontend.auth.logout.doctor.employee')}}" method="POST">
                  @csrf
                </form>
              </div>
            </li>
