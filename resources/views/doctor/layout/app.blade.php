...
<body class="vertical-layout vertical-menu 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu"
    ...
    @include('doctor.layout.template.menu')

    <!-- BEGIN: Main Menu-->

    @include('doctor.layout.template.nav')
    ...
    <footer class="footer footer-static footer-light navbar-border navbar-shadow">
        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span
                class="float-md-left d-block d-md-inline-block">Copyright &copy; 2024 <a
                    class="text-bold-800 grey darken-2" href="https://line-soft.com/"
                    target="_blank">LINESOFT</a></span></span></p>
    </footer>
    <!-- END: Footer-->
    ...
    <script>
        var table = new DataTable('.table', {
            language: {
                url: 'https://cdn.datatables.net/plug-ins/2.1.3/i18n/ar.json',
            },
        });
        ...
        // If you want to open in a new tab, use the following line instead
