    ...
    <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
      <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
        ...
        <div class="card-content">
          ...
          <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1"><span>تسجيل الدخول كـ مدير</span></p>
          <div class="card-body">
            <form class="form-horizontal" autocomplete="off" action="{{ route('doctor.login') }}" method="POST" >
                @error('email')
            ...
            @enderror
                ...
                <input type="text" value="admin@gmail.com" class="form-control" id="user-name" placeholder="ادخل البريد" name="email" required>
